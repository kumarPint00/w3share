...
var ClaimController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Claim'), (0, common_1.Controller)('claim')];
    ...
    var ClaimController = _classThis = /** @class */ (function () {
        ...
        ClaimController_1.prototype.submit = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {

                    return [2 /*return*/, this.claimService.submitClaim(dto.giftId, dto.claimer)];
                });
            });
        };
        ClaimController_1.prototype.status = function (giftId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.claimService.getStatus(parseInt(giftId, 10))];
                });
            });
        };
    ...
    (function () {
        ...
        _submit_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({ summary: 'Submit a gasless claim for a gift' }), (0, swagger_1.ApiOkResponse)({ schema: { example: { taskId: '0xabc123' } } })];
        _status_decorators = [(0, common_1.Get)('status/:giftId'), (0, swagger_1.ApiOperation)({ summary: 'Check claim status for a gift' }), (0, swagger_1.ApiParam)({ name: 'giftId', description: 'On-chain gift ID' }), (0, swagger_1.ApiOkResponse)({ schema: { example: { status: 'CLAIMED', taskId: '0xabc123' } } })];
